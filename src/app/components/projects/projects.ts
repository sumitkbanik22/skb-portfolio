  ...
  projects = [
    {
      ...
      description: 'An institutional mediation & dispute resolution platform built for SGT University. Features public dispute submission, admin case management dashboard, complete case lifecycle tracking with role-based access, and an AI-powered chatbot for instant query resolution.',
      features: [
      ...
      tech: ['Angular', 'Node.js', 'Express', 'MongoDB', 'Gemini AI', 'JWT', 'Bootstrap 5', 'Multer'],
      url: 'samdoot-portal.vercel.app',
      liveUrl: 'https://samdoot-portal.vercel.app/',
      screenshot: '/projects/samdoot-portal.jpg',
